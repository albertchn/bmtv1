        ...
        <div class="container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $no++; ?></td>
                        <td class="divisi"><?= $d["foto"]; ?> </td>
                        <td class="tanggal"><?= $d["nama"]; ?></td>
                        <td class="kodesurat"><?= $d["nis"]; ?></td>
                        <td class="nosurat"><?=  $d["kelas"]; ?></td>
                        <td class="ket">
