        ...
        <div class="container">
            ...
            <table>
                <thead>
                    ...
                    <th style="background-color:#e0e0e0;" class="tabel-aksi">Transaksi</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    if( isset($_POST["cari"]) ) {
                        ...
                        $data = mysqli_query($conn, "SELECT transaksi.id_nasabah, nama, no_rekening, kelas, tanggal_lahir, foto, foto_ttd, rekening.teller as teller, sum(debit) as jumlah_debit, sum(kredit) as jumlah_kredit from rekening JOIN transaksi ON rekening.id_nasabah = transaksi.id_nasabah WHERE nama LIKE '%$keyword%' OR kelas LIKE '%$keyword%' OR no_rekening LIKE '%$keyword%' OR rekening.teller LIKE '%$keyword%' GROUP BY transaksi.id_nasabah");
                    }
